...
export const genreDimensionRanges = {
  ...
  sonataForm: {
    intimacy: [0, 5],    // team/unit bonding, not romantic
    powerDiff: [-4, 4],   // institutional/system power gaps
    infoAsym: [2, 9],    // hidden meta-system, layered ontology
    alignment: [1, 8],    // shifting alliances across movements
    proximity: [1, 7],    // forced proximity in conflict zones
    vulnerability: [0, 7],    // characters competent but exposed
    desire: [0, 4],    // existential/professional, rarely romantic
    stakes: [3, 10],   // high — survival, systems, civilizations
    trust: [1, 8],    // built/broken across thematic integration
    danger: [2, 9],    // baseline threat from environment/antagonist
    mystery: [3, 10],   // Theme B discovery is structural driver
  },
};
...
export const genreSystem = {
  ...
  sonataForm: {
    ...
    subgenres: {
      historicalMilitary: {
        name: 'Historical Military',
        weights: { infoAsym: 1.0, stakes: 1.6, misalignment: 1.1, powerDiff: 1.0, vulnerabilityTrust: 0.9, desireIntimacy: 0.2, proximityTrust: 0.7, danger: 1.6, mystery: 1.2 },
        requirements: { finalIntimacy: [0, 4], finalTrust: [5, 9], finalTension: [4, 8] },
        modifiers: ['Napoleonic', 'Ancient Rome', 'Medieval', 'WWI/WWII', 'Mercenary'],
      },
      litRPG: {
        name: 'LitRPG / Systems Fiction',
        weights: { infoAsym: 1.3, stakes: 1.4, misalignment: 0.9, powerDiff: 0.8, vulnerabilityTrust: 0.7, desireIntimacy: 0.3, proximityTrust: 0.6, danger: 1.3, mystery: 1.5 },
        requirements: { finalIntimacy: [0, 4], finalTrust: [6, 10], finalTension: [3, 7] },
        modifiers: ['System Mechanics', 'Progression', 'Portal Fantasy', 'Game World', 'Isekai'],
      },
      cosmicDetective: {
        name: 'Cosmic Detective',
        weights: { infoAsym: 1.7, stakes: 1.5, misalignment: 1.2, powerDiff: 0.9, vulnerabilityTrust: 1.0, desireIntimacy: 0.3, proximityTrust: 0.8, danger: 1.4, mystery: 1.8 },
        requirements: { finalIntimacy: [0, 3], finalTrust: [4, 8], finalTension: [5, 9] },
        modifiers: ['Ontological Mystery', 'Reality Anomaly', 'Multi-Layer', 'Meta-Plot', 'Cosmic Horror'],
      },
    },
  },
};
